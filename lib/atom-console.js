...
export default {
    ...
    activate(state) {
        ...
        //let histPath = `${process.env.ATOM_HOME}/packages/atom-console/lib/history.json`;
        //fs.access(histPath, err => fs.writeFile(histPath, '[]', err => {if (err) { console.log('Could not create history file!'); throw err; }}));
