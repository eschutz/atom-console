...
export default {
    ...
    activate(state) {
        ...
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            ...
            'atom-console:autocomplete': () => this.atomConsoleView.autocomplete()
        }));

        this.initialCursorHeight = parseInt(document.querySelector('atom-text-editor[mini].console .cursors .cursor').style.height.replace("px", ""));
